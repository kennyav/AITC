         ...
         <div id="separator-sidebar" className={`${styles.testFont} ${isOpen ? "translate-x-0" : "-translate-x-full"} ease-in-out duration-300 fixed top-0 left-0 z-40 w-64 h-screen`} aria-label="Sidebar">
            <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
               <ul className="space-y-2">
                  ...
                  <li>
                     <Link href="/section/createPoll" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <li>
                     <Link href="/section/landingPage" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
